...
package org.apache.nifi.processors.ngsi.neo4j;
...
import org.apache.nifi.ngsi.neo4j.BoltSessionPool;
...
@Tags({"cypher", "put", "graph", "query", "update", "insert", "neo4j", "database, FIWARE, NGSI"})
...
public class NGSIToNeo4j extends AbstractProcessor {
